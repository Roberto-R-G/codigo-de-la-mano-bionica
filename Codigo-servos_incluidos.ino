...
const int   UMBRAL    = 20;    // Umbral de activación (0 – 1023). Ajusta según tu señal EMG
const int   POS_ACT1  = 0;      // Posición servo1 al activarse
const int   POS_ACT2  = 0;    // Posición servo2 al activarse
const int   POS_REP1  = 90;     // Posición servo1 en reposo
const int   POS_REP2  = 90;     // Posición servo2 en reposo
...
void setup() {
  ...
  servo1.write(POS_REP1);
  servo2.write(POS_REP2);
}
...
void loop() {
  ...
  if (medida >= UMBRAL && !activado) {
    ...
    activado = true;
    servo1.write(POS_ACT1);
    servo2.write(POS_ACT2);
